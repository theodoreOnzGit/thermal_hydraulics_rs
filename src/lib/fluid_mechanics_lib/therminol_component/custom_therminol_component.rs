...
use crate::fluid_mechanics_lib::fluid_component_calculation::custom_component_calc;
...
/// ::therminol_component::custom_therminol_component::
///     DowthermACustomComponent;
///
/// use crate::thermal_hydraulics_rs::fluid_mechanics_lib
/// ::therminol_component::
