...
//                let custom_darcy: &dyn Fn(f64, f64) -> Result<f64,ThermalHydraulicsLibError> = 
//                    self.custom_darcy;
//
//                let custom_k : &dyn Fn(f64) -> Result<f64,ThermalHydraulicsLibError> =
//                    self.custom_k;
//
//                let pressure_loss =
