...
/// ```rust
///    let fldk = 
///        thermal_hydraulics_rs::fluid_mechanics_lib::fldk(
...
/// ```rust
/// let bejan_d = 
///     thermal_hydraulics_rs::fluid_mechanics_lib::get_bejan_d(
...
///
/// let reynolds_number = 
///     thermal_hydraulics_rs::fluid_mechanics_lib::get_reynolds_number(
...
impl CustomComponent {
    ...
    ///}
    ///let custom_fldk = 
    ///    thermal_hydraulics_rs::fluid_mechanics_lib::CustomComponent::fldk(
    ///        &custom_f,
    ///        -5000.0,
    ///        0.00014,
    ///        10.0,
    ...
    ///
    ///let custom_fldk = 
    ///    thermal_hydraulics_rs::fluid_mechanics_lib::CustomComponent::fldk_pipe(
    ///        1000.0,
    ///        0.00014,
    ///        10.0,
    ///        &custom_k);
    ...
    ///
    ///let custom_bejan = 
    ///    thermal_hydraulics_rs::fluid_mechanics_lib::CustomComponent::
    ...
    ///}
    ///let custom_bejan = 
    ///    thermal_hydraulics_rs::fluid_mechanics_lib::CustomComponent::get_bejan_custom_fldk(
    ///        &custom_f,
    ///        -5000.0,
    ///        0.00014,
    ///        10.0,
...
impl CalcReynolds {
    ...
    ///
    ///let reynolds_number = thermal_hydraulics_rs::fluid_mechanics_lib::CalcReynolds::from_mass_rate(
    ///    fluid_massflowrate,
    ///    pipe_xs_area,
    ///    pipe_diameter,
    ///    fluid_viscosity);
    ...
    ///
    ///let reynolds_number = thermal_hydraulics_rs::fluid_mechanics_lib::CalcReynolds::from_velocity(
    ///    fluid_density,
    ///    fluid_velocity,
    ///    pipe_diameter,
    ///    fluid_viscosity);
    ...
    ///
    ///println!("Reynolds number: {} \n", reynolds_number);
    ///let test_fluid_mass_flowrate = thermal_hydraulics_rs::fluid_mechanics_lib::CalcReynolds::to_mass_rate(
    ///    pipe_xs_area,
    ///    reynolds_number,
    ///    pipe_diameter,
    ///    fluid_viscosity);
...
impl CalcBejan {
    ...
    /// let fluid_viscosity = DynamicViscosity::new::<pascal_second>(0.001);
    ///
    /// let bejan_number = thermal_hydraulics_rs::fluid_mechanics_lib::CalcBejan::from_pressure(
    ///     fluid_pressure,
    ///     pipe_diameter,
    ///     fluid_density,
    ///     fluid_viscosity);
    ...
    /// println!("Bejan number: {} \n", bejan_number);
    ///
    /// let test_fluid_pressure = thermal_hydraulics_rs::fluid_mechanics_lib::CalcBejan::to_pressure(
    ///     bejan_number,
    ///     pipe_diameter,
    ///     fluid_density,
    ///     fluid_viscosity);
