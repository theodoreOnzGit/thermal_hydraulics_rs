use crate::boussinesq_solver::array_control_vol_and_fluid_component_collections::{fluid_component_collection::{fluid_component::FluidComponent, fluid_component_traits::FluidComponentTrait}, one_d_fluid_array_with_lateral_coupling::FluidArray};
use uom::si::f64::*;
